    ...
    <div class="col-12 body-items">
        <p>
            <input type="checkbox" id="chRegisterAll" name="chRegisterAll" error-value="{{ trans('validation.javascript_validation.organs') }}"
                   @if(Auth::check() and strpos(Auth::user()->organs, 'Heart Lung Liver Kidney Pancreas Tissues') !== false)
                   checked="checked"
                    @endif
            >
        ...
        <input type="checkbox" id="chRegisterHeart" name="chRegisterHeart"
               @if(Auth::check() and strpos(Auth::user()->organs, 'Heart') !== false)
               checked="checked"
                @endif
        >
        ...
        <input type="checkbox" id="chRegisterLung" name="chRegisterLung"
               @if(Auth::check() and strpos(Auth::user()->organs, 'Lung') !== false)
               checked="checked"
                @endif
        >
        ...
        <input type="checkbox" id="chRegisterLiver" name="chRegisterLiver"
               @if(Auth::check() and strpos(Auth::user()->organs, 'Liver') !== false)
               checked="checked"
                @endif
        >
        ...
        <input type="checkbox" id="chRegisterKidney" name="chRegisterKidney"
               @if(Auth::check() and strpos(Auth::user()->organs, 'Kidney') !== false)
               checked="checked"
                @endif
        >
        ...
        <input type="checkbox" id="chRegisterPancreas" name="chRegisterPancreas"
               @if(Auth::check() and strpos(Auth::user()->organs, 'Pancreas') !== false)
               checked="checked"
                @endif
        >
        ...
        <input type="checkbox" id="chRegisterTissues" name="chRegisterTissues"
               @if(Auth::check() and strpos(Auth::user()->organs, 'Tissues') !== false)
               checked="checked"
                @endif
        >
