...
<body class="image-background fp-viewing-1stPage" bg-image="{{ url('assets/photos/posts/landing/summer.jpg') }}" style="overflow: visible; height: initial;">
<img src="{{ url('assets/photos/posts/landing/summer-hand.png') }}" class="hand">
<!-- Preloader -->
