		...
		<ul class="sidebar-nav">
			...
			<li>
				<a href="#">
					...
					<div class=""><a href="{{ URL::to('/manage/index') }}">صفحه نخست</a></div>
				</a>
			</li>
			<li>
				...
				<ul class="sidebar-nav sidebar-child" style="display: none;">
					<li>
						<a href="#">
							...
							<div class=""><a href="{{ URL::to('/manage/index') }}"> افزودن خبر</a></div>
						</a>
					</li>
					<li>
						<a href="#">
							<div class="glyphicon glyphicon-list sidebarIcon"></div>
							<div class=""><a href="{{ URL::to('/manage/index') }}">لیست اخبار</a>
							</div>
						</a>
					</li>
				</ul>
