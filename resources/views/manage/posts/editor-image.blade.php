@if($model->branch()->hasFeature('image'))
	<div class="panel panel-default w100">
		...
		<div class="m10 text-center" style="">
			...
			<input id="txtFeaturedImage" type="hidden" name="featured_image" value="{{ url($model->featured_image) }}">
			<div id="divFeaturedImage" class="{{ $model->featured_image? '' : 'noDisplay' }}">
				<div class="text-center">
					<img id="imgFeaturedImage" src="{{ url($model->featured_image) }}" style="margin-top:15px;max-height:100px;" ondblclick="postEditorFeatures('delete_featured_image')">
				</div>
