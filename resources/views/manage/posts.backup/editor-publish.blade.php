<div class="panel panel-default w100 -publish-now">
	...
	<div class="text-center m10">
		<button type="button" class="btn btn-success btn-sm" onclick="postSave('publish')">
			{{ $model->isPublished() || $model->published_by? trans('posts.manage.update') : trans('posts.manage.publish_now') }}
		</button>
	</div>
	...
	@if($model->isPublished())
		<div class="text-center m10">
			<a type="button" href="#" class="btn btn-link btn-sm" onclick="$('#divUnpublishWarning').slideDown('fast')">
	...
	@if(!$model->isPublished() and !$model->published_by)
		<div class="text-center m10">
