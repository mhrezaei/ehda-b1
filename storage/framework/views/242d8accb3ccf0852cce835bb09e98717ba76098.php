<title><?php echo e(trans('global.siteTitle')); ?> | <?php echo e(trans('site.global.card_edit_page')); ?></title>
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <?php echo $__env->make('site.members.edit_my_card.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
