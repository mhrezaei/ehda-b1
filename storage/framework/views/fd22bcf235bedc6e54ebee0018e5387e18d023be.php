<?php if($user): ?>
    <table style="width: 100%; font-family: Tahoma; font-size: 12px; border: 1px solid black; direction: rtl;">
        ...
        <?php foreach($user as $u): ?>
                <tr>
                    <th style="border: 1px solid black;"><?php echo e($row++); ?></th>
                    <td style="border: 1px solid black;">
                        ...
                        تاریخ تولد: <?php echo e($u->say('birth_date')); ?><hr>
                        تحصیلات: <?php echo e($u->say('edu_level')); ?> - <?php echo e($u->say('edu_field')); ?>
