<?php $__env->startSection('section'); ?>
	...
	*/ ?>
	<div class="panel panel-toolbar row w100">
		<div class="col-md-4"><p class="title"><?php echo e(trans('manage.devSettings.activities.trans')); ?></p></div>
		<div class="col-md-8 tools">

			<?php echo $__env->make('manage.frame.widgets.toolbar_button' , [
				'target' => "masterModal('".url('manage/devSettings/activities/0/edit/')."')" ,
				'type' => 'success' ,
				'caption' => trans('forms.button.add') ,
				'icon' => 'plus-circle' ,
			], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
			<?php echo $__env->make('manage.frame.widgets.toolbar_search' , [
				'target' => url('manage/devSettings/activities/search/-key-') ,
			...
			<table class="table table-hover">
				...
				<?php foreach($model_data as $key=> $model): ?>
					<tr>
						...
						<td>
							<a href="javascript:void(0)" onclick="masterModal('<?php echo e(url("manage/devSettings/activities/$model->id/edit")); ?>')">
